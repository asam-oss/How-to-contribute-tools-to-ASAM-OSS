...
. ASAM membership
. Carefully read and agree to https://github.com/asam-oss/How-to-contribute-tools-to-ASAM-OSS/blob/master/DISCLAIMER.md[ASAM OSS Disclaimer (link to file)]
...
. Commit Hook enforcing DCO. See https://github.com/asam-oss/How-to-contribute-tools-to-ASAM-OSS/blob/master/DISCLAIMER.md[Disclaimer (link to file)]
